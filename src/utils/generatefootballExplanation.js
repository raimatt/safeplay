export function generatefootballExplanation(score, answers) {
    ...
    let result = topThree.map(([injury]) => {
        ...
        if (reasons.length === 0) {
            reasons.push("of your playing profile and physical demands");
        }
...
import { calculatefootballRisk } from "./calculatefootballRisk.js";
...
let score = calculatefootballRisk(answers);

console.log(generatefootballExplanation(score, answers)); */